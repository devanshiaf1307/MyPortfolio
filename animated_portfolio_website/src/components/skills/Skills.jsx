...
import { IoLogoHtml5, IoLogoCss3, IoLogoAndroid, IoLogoGithub} from "react-icons/io";
import { SiJava, SiPython, SiMysql } from "react-icons/si";
          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                <ProgressBar logo={<SiJava />} name={"Java"} value={92} />
                ...
                <ProgressBar logo={<SiJavascript />} name={"Javascript"} value={70} />
                <ProgressBar logo={<FaReact />} name={"React Js"} value={85} />
                <ProgressBar logo={<IoLogoNodejs />} name={"Nodejs"} value={75} />
              </div>
            </div>
          </div>
          {/* right box */}
